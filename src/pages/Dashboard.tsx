...
import { LogOut, Shield, UserPlus, CheckCircle2, AlertCircle, Bluetooth, BluetoothConnected, Sparkles, Activity, BarChart3, Bell } from 'lucide-react';
import { useAuth } from '@/hooks/useAuth';
import { useAuthMethods } from '@/hooks/useAuthMethods';
import { useBluetooth } from '@/hooks/useBluetooth';
import { SensorDisplay } from '@/components/SensorDisplay';
import SensorDashboard from '@/components/dashboard/SensorDashboard';
import BleConnector from '@/components/ble/BleConnector';
import SensorHistory from '@/components/history/SensorHistory';
...
const Dashboard = () => {
  ...
  const [bleSensorData, setBleSensorData] = useState<SensorData | null>(null);
  ...
  const handleSensorDataUpdate = (data: SensorData) => {
    setBleSensorData(data);
  };
      ...
      <div className="max-w-6xl mx-auto space-y-6 py-8 px-4 animate-fade-in">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-100">AuthentiX Dashboard</h1>
